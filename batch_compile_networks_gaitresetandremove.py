...
if SwimProblem:
    ...
    RandomMessToSwimThroughInitialisationTwoParticle = 'false'
    ...
    GaitReset = 'true'
    SaveExtendedForcesData = True

    initialFrictionSteps = 0 #0 # 1000

    StepsPerPeriod = 300
    RandomMessNumNetworkFilaments = [200]#[200,400]  # [180, 300, 420]
    Nsw = [1 + i for i in RandomMessNumNetworkFilaments]
    TimeSteps = 5 * StepsPerPeriod #22  # Total timesteps
    Kap_NetworkFilaments = [1000]#[1,1000]  # [3.6, 36, 3600]
            ...
            for j, NPTS_i in enumerate(NPTS):
                for randSeed_i in randSeed:
                    ...
                    with open('config.hpp', 'r') as file:
                        ...
                        filedata = filedata.replace('xxSaveExtendedForcesData', ['false', 'true'][int(SaveExtendedForcesData)])
                    ...
                    subprocess.call("./make_wrapper_cx2_gaitresetandremove.sh")  # Make
