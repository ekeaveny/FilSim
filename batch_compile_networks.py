...
NPTS = [[288 * 1, 288 * 1, 288 * 1]]  # [NPTS_X, NPTS_Y, NPTS_Z]
#NPTS = [[384 * 1, 384 * 1, 384 * 1]]  # [NPTS_X, NPTS_Y, NPTS_Z]
...
if SwimProblem:
    ...
    initialFrictionSteps = 0 #1000#1000#3000

    StepsPerPeriod = 300 # 300 # 1000 #300
    RandomMessNumNetworkFilaments = [200]#[1200,2000]#[200,400]  # [180, 300, 420]
    Nsw = [1 + i for i in RandomMessNumNetworkFilaments]
    TimeSteps = int(5* StepsPerPeriod)  # Total timesteps, traditionally 22
    Kap_NetworkFilaments = [1000]#[1,1000]#,1000]# , [1,1000]
