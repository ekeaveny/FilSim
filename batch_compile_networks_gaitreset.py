...
if SwimProblem:
    ...
    StepsPerPeriod = 300
    RandomMessNumNetworkFilaments = [2000]#[200,400]  # [180, 300, 420]
    Nsw = [1 + i for i in RandomMessNumNetworkFilaments]
    TimeSteps = 22 * StepsPerPeriod #22  # Total timesteps
    Kap_NetworkFilaments = [1,1000]#[1,1000]  # [3.6, 36, 3600]
        ...
        for k, Bnumber_i in enumerate(Bnumber):
            for j, NPTS_i in enumerate(NPTS):
                for randSeed_i in randSeed:
                    ...
                    subprocess.call("./make_wrapper_cx2_gaitreset.sh")  # Make
